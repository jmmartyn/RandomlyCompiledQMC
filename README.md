...
* `Randomly_Compiled_Quantum_Trajectories_BoseHubbard.ipynb` - RC-QMC applied to the quantum trajectories method (using the [randomly corrected Trotterization]([https://journals.aps.org/prl/abstract/10.1103/PhysRevLett.123.070503)), exemplified on simulating the dynamics of a dissipative Bose-Hubbard model. 
