...
* `Randomly_Compiled_Quantum_Trajectories_BoseHubbard.ipynb` - RC-QMC applied to the quantum trajectories method, exemplified on simulating the dynamics of a dissipative Bose-Hubbard model. 
