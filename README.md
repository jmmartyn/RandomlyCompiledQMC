...
In [Faster Quantum Monte Carlo Simulation by Random Compilation](https://arxiv.org/abs/2609.10486), we develop *randomly compiled quantum Monte Carlo* (RC-QMC) as a framework to improve the accuracy and efficiency of quantum Monte Carlo simulation algorithms. We apply RC-QMC to both path integral Monte Carlo and the quantum trajectories method. 
